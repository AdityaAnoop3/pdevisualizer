...
class TestEnhancedVisualizer:
    ...
    def test_plot_contours_lines_only(self):
        ...
        fig = EnhancedVisualizer.plot_contours(
            solution, title="Line Contours", fill_contours=False, levels=10
        )
    ...
    def test_plot_solution_comparison_enhanced(self):
        ...
        fig = EnhancedVisualizer.plot_solution_comparison_enhanced(
            solutions, plot_types=["heatmap", "contour"], figsize=(15, 10)
        )
    ...
    def test_plot_parameter_sweep_enhanced(self):
        ...
        fig = EnhancedVisualizer.plot_parameter_sweep_enhanced(
            sweep_result, include_heatmaps=True, include_contours=True, figsize=(15, 12)
        )
    ...
    def test_plot_parameter_sweep_enhanced_minimal(self):
        ...
        metrics = {"max_value": np.array([1.0, 0.8]), "total_energy": np.array([50.0, 40.0])}
        ...
        fig = EnhancedVisualizer.plot_parameter_sweep_enhanced(
            sweep_result, include_heatmaps=False, include_contours=False, figsize=(10, 6)
        )
    ...
    def test_plot_wave_comparison(self):
        ...
        solutions = {"Wave A": np.random.rand(10, 10) - 0.5, "Wave B": np.random.rand(10, 10) - 0.5}

        fig = EnhancedVisualizer.plot_wave_comparison(
            solutions, symmetric_colormap=True, figsize=(12, 6)
        )
    ...
    def test_plot_heat_comparison(self):
        ...
        solutions = {"Heat A": np.random.rand(10, 10), "Heat B": np.random.rand(10, 10)}

        fig = EnhancedVisualizer.plot_heat_comparison(solutions, figsize=(12, 6))
...
class TestEnhancedVisualizationIntegration:
    ...
    def test_boundary_condition_visualization(self):
        ...
        fig = EnhancedVisualizer.plot_solution_comparison_enhanced(
            solutions, plot_types=["heatmap", "contour"], figsize=(12, 8)
        )
...
class TestEnhancedVisualizationEdgeCases:
    ...
    def test_parameter_sweep_single_solution(self):
        ...
        metrics = {"max_value": np.array([1.0]), "total_energy": np.array([50.0])}
