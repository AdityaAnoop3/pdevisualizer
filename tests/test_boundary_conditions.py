...
class TestUnifiedSolverBoundaries:
    ...
    def test_wave_solver_with_periodic_boundaries(self):
        ...
        solver = PDESolver(
            equation="wave", grid_shape=(30, 30), boundary=BoundaryCondition.periodic()
        )
    ...
    def test_wave_solver_with_absorbing_boundaries(self):
        ...
        solver = PDESolver(
            equation="wave", grid_shape=(30, 30), boundary=BoundaryCondition.absorbing()
        )
...
class TestBoundaryConditionComparison:
    ...
    def test_heat_boundary_comparison(self):
        ...
        solver_dirichlet = PDESolver(
            "heat", grid_shape=(20, 20), boundary=BoundaryCondition.dirichlet(0.0)
        )
        ...
        solver_neumann = PDESolver(
            "heat", grid_shape=(20, 20), boundary=BoundaryCondition.neumann(0.0)
        )
        ...
        # Periodic boundaries
        solver_periodic = PDESolver(
            "heat", grid_shape=(20, 20), boundary=BoundaryCondition.periodic()
        )
