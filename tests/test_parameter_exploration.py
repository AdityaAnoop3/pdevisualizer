...
class TestParameterSweep:
    ...
    def test_wave_c_sweep(self):
        ...
        result = explorer.parameter_sweep("c", c_values, custom_params={"steps": 50})
...
class TestParameterComparison:
    ...
    def test_compare_wave_parameters(self):
        ...
        # Define parameter configurations
        configs = [{"c": 0.5, "dt": 0.05, "steps": 100}, {"c": 1.5, "dt": 0.05, "steps": 100}]
...
class TestSensitivityAnalysis:
    ...
    def test_sensitivity_analysis_heat(self):
        ...
        result = explorer.sensitivity_analysis(
            "alpha", base_value=0.25, perturbation_percent=20.0, n_samples=5
        )
    ...
    def test_sensitivity_analysis_single_sample(self):
        ...
        result = explorer.sensitivity_analysis("alpha", base_value=0.2, n_samples=1)
...
class TestParameterVisualizer:
    ...
    def test_plot_sensitivity_analysis(self):
        ...
        sensitivity_result = {
            ...
            "sensitivity_metrics": {"max_value": 0.5, "total_energy": 0.3},
        }
    ...
    def test_plot_parameter_grid(self):
        ...
        fig = ParameterVisualizer.plot_parameter_grid(
            explorer, "alpha", param1_values, "dt", param2_values, figsize=(8, 6)
        )
...
class TestIntegrationExamples:
    ...
    def test_complete_heat_exploration_workflow(self):
        ...
        u0 = InitialConditions.multiple_sources((15, 15), [(5, 5, 100.0), (10, 10, 80.0)])
        explorer.set_initial_conditions(u0)

        # Run parameter sweep
        alpha_values = np.linspace(0.1, 0.3, 3)
        sweep_result = explorer.parameter_sweep("alpha", alpha_values, custom_params={"steps": 50})
        ...
        configs = [{"alpha": 0.1, "dt": 0.1}, {"alpha": 0.3, "dt": 0.1}]
        comparison_results = explorer.compare_parameters(configs, ["Low α", "High α"])
        ...
        # Run sensitivity analysis
        sensitivity_result = explorer.sensitivity_analysis("alpha", 0.2, perturbation_percent=10)
    ...
    def test_complete_wave_exploration_workflow(self):
        ...
        c_values = np.array([0.5, 1.0, 1.5])
        sweep_result = explorer.parameter_sweep("c", c_values, custom_params={"steps": 100})
        ...
        configs = [{"c": 1.0, "dt": 0.02}, {"c": 1.0, "dt": 0.05}, {"c": 1.0, "dt": 0.08}]
        comparison_results = explorer.compare_parameters(
            configs, ["Fine dt", "Medium dt", "Coarse dt"]
        )
        ...
        # Test visualization
        fig1 = ParameterVisualizer.plot_parameter_sweep(
            sweep_result, metric_names=["max_value", "total_energy"]
        )
        fig2 = ParameterVisualizer.plot_solution_comparison(comparison_results)
    ...
    def test_boundary_condition_parameter_exploration(self):
        ...
        for boundary in boundary_conditions:
            ...
            sweep_result = explorer.parameter_sweep(
                "alpha", alpha_values, custom_params={"steps": 30}
            )
