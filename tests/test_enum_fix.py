...
def test_solver_integration():
    ...
    solver = PDESolver("heat", grid_shape=(10, 10), boundary=BoundaryCondition.dirichlet(0.0))
    ...
    solver_neumann = PDESolver("heat", grid_shape=(10, 10), boundary=BoundaryCondition.neumann(0.0))
